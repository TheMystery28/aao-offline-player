...
(function() {
	...
	function executeTests() {
		...
		['Save IDB: API Exists (anti-regression)', typeof testSaveIdbApiExists === 'function' ? testSaveIdbApiExists : null],
		['Save IDB: Roundtrip Integrity (anti-regression)', typeof testSaveIdbRoundtrip === 'function' ? testSaveIdbRoundtrip : null],
		['Save IDB: Guard Behaviors (anti-regression)', typeof testSaveIdbGuardBehaviors === 'function' ? testSaveIdbGuardBehaviors : null],
		['Save IDB: Bridge Protocol (anti-regression)', typeof testSaveIdbBridgeProtocol === 'function' ? testSaveIdbBridgeProtocol : null],
		['Save IDB: refreshSavesList Does Not Throw (anti-regression)', typeof testSaveIdbRefreshDoesNotThrow === 'function' ? testSaveIdbRefreshDoesNotThrow : null],
		['Save IDB: GameSavesDB Helper Exists (proving)', typeof testSaveIdbHelperExists === 'function' ? testSaveIdbHelperExists : null],
		['Save IDB: player_save.js Uses IndexedDB (proving)', typeof testSaveIdbPlayerSaveUsesIdb === 'function' ? testSaveIdbPlayerSaveUsesIdb : null],
		['Save IDB: localstorage_bridge.html Uses IndexedDB (proving)', typeof testSaveIdbBridgeUsesIdb === 'function' ? testSaveIdbBridgeUsesIdb : null],
